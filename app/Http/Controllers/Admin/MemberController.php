...
class MemberController extends Controller
{
    ...
    public function updateMember(Request $request, $id)
    {
        ...
        try {
            ...
            UpdateNikOrg::update($oldNik, $request);
            DB::commit();
            // return $update;
    ...
    public function setStoreSpamMember($user, $originaluser, $request, $category_inactive_member)
    {
        ...
        return TmpSpamUser::create([
            ...
            'place_berth' => $user->place_berth ?? null,
            'date_berth'  => $user->date_berth ?? null,
            ...
            'cby' => $user->cby ?? null,
            'saved_nasdem' => $user->saved_nasdem ?? null,
            'activate_token' => $user->activate_token ?? null,
            'status' => $user->status,
            'remember_token' => $user->remember_token ?? null,
            'set_admin' => $user->set_admin ?? null,
