...
function setAjaxInfoCard(){
	return new Promise((resolve, reject) => {
			$.ajax({
			url: "/api/member/totalvillage/caleg" + "/" + districtID + "/" + villageID + "/" + userId,
			method: "GET",
			dataType: "json",
			cache: false,
			async: true,
...
function setAjaxGender(){
	return new Promise((resolve, reject) => {
		$.ajax({
			url: "/api/member/gender/village/caleg" + "/" + villageID + "/" + userId,
			method: "GET",
			dataType: "json",
			cache: false,
			async: true,
...
function setAjaxJob(){
	return new Promise((resolve, reject) => {
		$.ajax({
			url: "/api/member/jobs/village/caleg" + "/" + villageID + "/" + userId,
			method: "GET",
			dataType: "json",
			cache: false,
			async: true,
...
function setAjaxgAgeGroup(){
	return new Promise((resolve, reject) => {
		$.ajax({
			url: "/api/member/agegroup/village/caleg" + "/" + villageID + "/" + userId,
			method: "GET",
			dataType: "json",
			cache: false,
			async: true,
...
function setAjaxgAgeGeneration(){
	return new Promise((resolve, reject) => {
		$.ajax({
			url: "/api/member/genage/village/caleg" + "/" + villageID + "/" + userId,
			method: "GET",
			dataType: "json",
			cache: false,
			async: true,
...
function setAjaxAdminInputTerbanyak(){
	return new Promise((resolve, reject) => {
			$.ajax({
			url: "/api/member/inputer/village/caleg" + "/" + villageID + "/" + userId,
			method: "GET",
			dataType: "json",
			cache: false,
			async: true,
...
function setAjaxMemberReferalTerbanyak(){
	return new Promise((resolve, reject) => {
		$.ajax({
			url: "/api/member/referal/village/caleg" + "/" + villageID + "/" + userId,
			method: "GET",
			dataType: "json",
			cache: false,
			async: true,
