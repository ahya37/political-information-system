...
//     try {
//         const inputByMounth = await getInputByDefault(districtID);
...
//     return fetch("/api/dashboard/inputbymonthdistrictdefault", {
//         method: "POST",
//         headers: {
...
//     return fetch("/api/dashboard/inputbymonthdistrict", {
//         method: "POST",
//         headers: {
//             Accept: "application/json",
//             "Content-Type": "application/json",
...
$("#totalInputByMonth", function (dateInputer, yearInputer) {
    getTotalInputByMonth(dateInputer, yearInputer, districtID);
});
...
const tableInputer = $("#dtshowInputDataByMounth").DataTable({
    ...
    autoWidth: false,
    ajax: {
        url: "/api/dashboard/inputbymonthdistrictdefault",
        type: "POST",
        data: function (d) {
...
function getTotalInputByMonth(dateInputer, yearInputer, districtID) {
    return $.ajax({
        url: "/api/dashboard/totalinputbymonthdistrictdefault",
        method: "POST",
        data: {
