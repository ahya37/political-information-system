<html>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>BIAYA OPERASIONAL SAKSI KECAMATAN {{$district->name}}</title>
    </head>
    <style>
...
<body>
    ...
    <h4 style="margin-top:8px;border-color:#34495e" class="fonts">BIAYA OPERASIONAL SAKSI KECAMATAN {{$district->name}}</h4> 
            ...
            <table cellspacing='0' id="table">
                ...
                <tbody>
					...
					<tr>
						...
						<td align="center"><b>{{$jml_tps}}</b></td>
