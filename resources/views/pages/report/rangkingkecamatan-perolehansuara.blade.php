...
<body>
    ...
    <h4 style="margin-top:2px;border-color:#34495e" class="fonts">RANGKING KECAMATAN BERDASARKAN PERSENTASE</h4> 
	...
	<section>
            <table cellspacing='0' id="table" style="margin-top:-25px">
				...
				<tbody>
					...
					<tr>
						...
						<td align="right" style="padding:4px">{{$item['persentage_anggota']}} %</td>
					</tr>
					@endforeach
				</tbody>  
				<tfoot>
		...
		<h4 style="margin-top:-65px;border-color:#34495e;text-align:center" class="fonts">RANGKING KECAMATAN BERDASARKAN PEROLEHAN SUARA</h4> 
		<hr style="border:2px;margin-top:-15px"> 
		</header> 
		<section>
				<table cellspacing='0' id="table" style="margin-top:25px">
					...
					<tfoot>
					<tr>
						<td style="padding:4px" align="center" colspan="2"><b>JUMLAH </b></td> 
						<td align="right" style="padding:4px" ><b>{{$gf->decimalFormat($jml_all_anggota)}}</b></td>
						<td align="right" style="padding:4px" ><b>{{$gf->decimalFormat($jml_hasil_suara)}}</b></td>
						<td align="right" style="padding:4px" ><b>{{$persentage_anggota}} %</b></td>
					</tr>
