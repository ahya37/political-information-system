...
<body>
    <header>
	 <img src="{{asset('assets/images/kopsurataaw.png')}}" width="800" style="margin-top:-2px">
        <h4 style="margin-top:-4px;" class="fonts">SUMMARY SEMUA TIM</h5>
	...
	<section >
           <table cellspacing='0' class="table">
				...
				<tr>
					<td><b>Total</b></td><td align="right"><b>{{number_format($resultData['usia']['total_tim'])}}</b></td><td align="right"><b>{{$resultData['usia']['total_persen']}}</b></td>
				</tr>
			...
			<tr>
				<td><b>Total</b></td>
				<td align="right"><b>{{number_format($resultData['jk']['total_tim'])}}</b></td>
