<html>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>REKAP SAKSI DESA {{$village->name}}</title>
    </head>
    <style>
...
<body>
    ...
    <h4 style="margin-top:8px;border-color:#34495e" class="fonts">REKAP SAKSI DESA {{$village->name}}</h4> 
	...
	<section >
            <table cellspacing='0' id="table">
                <thead>
                    <tr>
                        <th style="padding:0.5px" rowspan="2">NO</th>
                        <th rowspan="2">TPS</th>
                ...
                <tbody>
					@foreach($results as $item)
						<tr>
							...
							<td align="center">{{$item['anggota']}}</td> 
							<td align="center">{{$item['anggota_form_manual']}}</td>  
					...
					<tr>
						...
						<td align="center"><b>{{$gF->decimalFormat($jml_anggota_kta_manual)}}</b></td>  
