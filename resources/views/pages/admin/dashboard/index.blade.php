                  ...
                  <div class="col-md-4">
                    <div class="card mb-2 text-white cd-card-primary">
                      <div class="card-body">
                        ...
                        <div class="dashboard-card-subtitle">
                          <h4 class="text-white">{{$persentage_target_member}}</h4>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-4">
                    <div class="card mb-2 bg-info">
                      <div class="card-body">
                        ...
                        <div class="dashboard-card-subtitle">
                          <h4 class="text-white">{{ $total_village_filled }}</h4>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="card mb-2 text-white cd-card-primary">
                      <div class="card-body">
                        ...
                        <div class="dashboard-card-subtitle">
                          <h4 class="text-white">{{ $presentage_village_filled}}</h4>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="card mb-2 text-white cs-card-danger">
                      <div class="card-body">
                        ...
                        <div class="dashboard-card-subtitle">
                          <h4 class="text-white">{{ $total_village }}</h4>
                        </div>
                      </div>
                    </div>
                  </div>
