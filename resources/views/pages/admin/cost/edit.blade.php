          ...
          >
            <div class="container-fluid">
                <div class="dashboard-heading">
                    <h2 class="dashboard-title">Edit Pengeluaran</h2>
            ...
            <div class="dashboard-content mt-4" id="transactionDetails">
                <div class="row">
                    ...
                    <form action="{{ route('admin-cost-update', $cost->id) }}" id="register" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="card">
                        <div class="card-body">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12">
                                                ...
                                                name="date"
                                                autocomplete="off"
                                                value="{{ date('d-m-Y', strtotime($cost->date)) }}"
                                                required >
                                            </div>
                                        </div>
                                    </div>                                       
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12">
                                                ...
                                                <select name="forecast_id" class="form-control select22">
                                                    ...
                                                    <option value="{{ $item->id }}" {{ $cost->forcest_id == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12">
                                                ...
                                                <select name="forecast_desc_id" class="form-control select22">
                                                    ...
                                                    <option value="{{ $item->id }}" {{ $cost->forecast_desc_id == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12">
                                               ...
                                               <input name="received_name"  class="form-control" value="{{ $cost->received_name }}">
                                            </div>
                                        </div>
                                    </div>
                                     <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12">
                                                <label>Jumlah</label>
                                               <input type="number" name="nominal" value="{{ $cost->nominal }}" class="form-control">
                                            </div>
                                        </div>
                                    </div>                                     
                                    <div class="form-group">
