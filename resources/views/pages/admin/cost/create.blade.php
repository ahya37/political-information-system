            ...
            <div class="dashboard-content mt-4" id="transactionDetails">
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <form action="{{ route('admin-cost-store') }}" id="register" method="POST"
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-12">
                                                        ...
                                                        <a href="#" data-toggle="modal" data-target="#Perkiraan"> +
                                                            Tambah Perkiraan</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-12">
                                                        ...
                                                        <a href="#" data-toggle="modal" data-target="#Uraian"> +
                                                            Tambah Uraian</a>
                                                    </div>
                                                </div>
                                            </div>
...
@endsection
@push('prepend-script')
    <div class="modal fade" id="Perkiraan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
    ...
    <div class="modal fade" id="Uraian" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
