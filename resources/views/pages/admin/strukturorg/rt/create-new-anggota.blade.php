          ...
          >
            ...
            <div class="dashboard-content mt-4" id="transactionDetails">
                <div class="row">
                    ...
                    <form action="{{ route('admin-kortps-create-new-anggota-store', $id) }}" id="register" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="card">
                        <div class="card-body">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12">
                                                ...
                                                <input class="form-control" type="hidden" name="new_idx" value="{{$result_new_idx}}">
                                                <input type="text" name="name" value="{{ $anggotaKorTps->name }}"   required class="form-control" />
                                            </div>
                                            <div class="col-md-6 col-sm-12">
                                                <span class="required">*</span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="address" required class="form-control"  value="{{ old('address') }}"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <input type="checkbox"
                                                name="checkedEmail"
