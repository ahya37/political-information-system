            ...
            <div class="row mt-4">
                <div class="col-12 mt-2">
                    <div class="card card-body">
                        ...
                        <form action="{{ route('admin-struktur-organisasi-rt-update', $id) }}" id="register"
                            ...
                            <div class="form-group">
                                <label>RT</label>
                                <input type="number" class="form-control" name="rts" value="{{ $korte->rt ?? 0 }}" required>
                            </div>
                            <div class="form-group">
                                <label>No.Hp / WA</label>
                                <input class="form-control" name="telp" value="{{ $korte->telp ?? 0 }}" required>
                            </div>
                            <div class="form-group">
