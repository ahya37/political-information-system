        ...
        <div class="dashboard-content mt-4" id="transactionDetails">
            ...
            <div class="row">
                <div class="col-md-8 mt-2 mb-2">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="acr tpsexist text-primary " data-toggle="collapse" href="#collapseExample"
                                role="button" aria-expanded="true" aria-controls="collapseExample">TPS Sudah Terisi
                                <span class="tpsexist" id="loadlisttpsexists"></span></h5>
                ...
                <div class="col-md-4 mt-2 mb-2">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="acr tpsnotexist  text-primary" data-toggle="collapse" href="#collapseExample2"
                                role="button" aria-expanded="true" aria-controls="collapseExample2">TPS Belum Terisi
                                <span class="tpsnotexist" id="loadlisttpsnotexists"></span></h5>
                            <div class="col-md-6">
