    ...
    <div class="section-content section-dashboard-home mb-4" data-aos="fade-up">
        <div class="container-fluid">
            <div class="dashboard-heading">
                <h2 class="dashboard-title">Tambah Struktur Organisasi Desa</h2>
            ...
            <div class="row mt-4">
                <div class="col-12 mt-2">
                    <div class="card card-body">
                        ...
                        <form action="{{ route('admin-struktur-organisasi-village-save') }}" id="register"
                            ...
                            <div class="form-group">
                                ...
                                <select name="jabatan" class="form-control" id="jabatan">
                                    ...
                                    <option value="KOR RT">KOR RT</option>
                                </select>
                            </div>
                            <div class="form-group" id="divSelectRt" style="display:none">
...
@push('addon-script')
    ...
    <script src="{{ asset('js/create-org-village.js') }}"></script>
@endpush
