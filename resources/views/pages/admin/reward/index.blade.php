              ...
              <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="input-group mb-3 col-md-3 float-right">
                        ...
                        <button type="button" id="date" name="referalOfMount"
                            class="btn btn-sm btn-sc-primary datepicker">Bulan</button>
                    </div>
                </div>
                <div class="row mb-2">
                                        ...
                                        <div class="table-responsive">
                                            <table id="data" class="table table-sm table-striped" width="100%">
                                                <thead>
                                                    ...
                                                    <tr>
                                                        <th colspan="6" id="LoadaReferalByMounth"
                                                            class="d-none lds-dual-ring hidden overlay"></th>
                                                    </tr>
                                                </thead>
    ...
    <div class="modal fade" id="setPoint" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('admin-customvoucher') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="referal" id="referal" class="form-control">
                            <input type="number" name="pointReq" id="pointReq" class="form-control"
                                placeholder="Jumlah poin yang akan diberikan">
                        </div>
...
@push('addon-script')
    ...
    <script>
        $('#setPoint').on('show.bs.modal', function(event) {
            ...
            let referal = button.data('referal')
            let modal = $(this)
            ...
            modal.find('.modal-body #pointReq').attr({
                "max": point
            })
        })
