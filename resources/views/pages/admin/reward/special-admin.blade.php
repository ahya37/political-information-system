          ...
          >
            <div class="container-fluid">
              <div class="dashboard-heading">
                <h2 class="dashboard-title">Reward Khusus Admin</h2>
              ...
              <div class="dashboard-content mt-4" id="transactionDetails">
                <div class="row">
                    <div class="input-group mb-3 col-md-3 ">
                        <a href="{{route('admin-reward-special-admin-report')}}" class="btn btn-sm btn-sc-primary text-light float-right">Download</a>
                    </div>
                  </div>
                <div class="row">
                  <div class="col-12">
...
<script src="{{ asset('js/reward-special-admin.js') }}"></script>
