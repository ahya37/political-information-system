...
@section('title', 'Edit Serumah Baru')
@push('addon-style')
    ...
    <div class="section-content section-dashboard-home mb-4" data-aos="fade-up">
        <div class="container-fluid">
            <div class="dashboard-heading">
                <h2 class="dashboard-title">Edit Keluarga Serumah : <strong>{{ $familyGroup->user->name }}</strong></h2>
            ...
            <div class="row mt-4">
                <div class="col-12 mt-2">
                    <div class="card card-body">
                        ...
                        <form action="{{ route('admin-familygroup-update', $familyGroup->id) }}" id="register"
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="notes">{{ $familyGroup->notes }}</textarea>
                            </div>
                            <div class="form-group">
