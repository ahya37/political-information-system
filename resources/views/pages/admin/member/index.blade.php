          ...
          <div class="card">
            <div class="card-body">
              <div class="row">
                      ...
                      <form action="{{ route('member-download-excel') }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="col-md-12 col-sm-12 ">
                          ...
                          <button type="submit" name="type" value="excel"
                            class="btn btn-sm btn-sc-primary text-white">Downlaod Excel</button>
                        </div>
                    </div>
                  </div>
                ...
                <div class="col-3">
                  <div class="form-group">
                    <button type="submit" name="type" value="pdf" class="btn btn-sm btn-sc-primary text-white">Download
                      PDF</button>
