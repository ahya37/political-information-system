                    ...
                    <div class="card card-body mb-4">
                        <div class="row">
                            ...
                            <div class="form-group">
                                <input value="{{ $regency->id }}" name="regency_id" type="hidden" id="regencyId" class="form-control">
                            </div>
                            {{-- </div> --}}
                            <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                    <div class="dropdown">
                                      ...
                                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <button class="dropdown-item btn-sm" type="submit" name="report_type" value="galery">Download
                                          Galeri</button>
                                        <button class="dropdown-item btn-sm" type="submit" name="report_type" value="sapaanggota">Download Sapa Anggota</button>
                                      </div>
                                    </div>
                            </div>
                        </div>
