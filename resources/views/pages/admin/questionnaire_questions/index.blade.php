              ...
              <div class="dashboard-content mt-4" id="transactionDetails">
                <div class="row">
                  <div class="col-12">
                    ...
                    <div class="card">
                      <div class="card-body">
                        <a href="/admin/questionnairequestion/create/{{ $id }}" class="btn btn-primary btn-sc-primary text-light btn-sm" style="margin-bottom: 30px;"><i class="fa fa-plus"></i> Tambah Pertanyaan Kuisioner</a>
                        {{-- <a href="/admin/questionnairequestion/create/{{ $id }}" class="btn btn-primary text-light">Tambah</a> --}}
