...
Route::group(['prefix' => 'admin','namespace' => 'Admin'], function(){
    ...
    Route::group(['middleware' => 'admin'], function(){
        ...
        #LAPORAN SURAT PERNYATAAN, PERMOHONAN, DAN DAFTAR PEMILIH
        Route::get('/exportlaporan', 'LaporanController@exportDaftarPemilih')->name('exportDaftar');
        Route::get('/exportSurat', 'LaporanController@exportSurat')->name('exportSurat');
        Route::get('/exportPermohonan', 'LaporanController@exportPermohonan')->name('exportPermohonan');
